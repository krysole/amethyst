...
AM__defineClass("Object", "instance", [], ["Class"]);

AM__defineClass("Class", "instance", [], ["Class"]);

AM__defineClass("Metaclass", "instance", [], ["Class"]);

AM__defineClass("Test", "abstract", [], ["Class"]);

AM__defineMethod("Test.class", "print", "public",
  function SEL__Test__class__print(message) {
    AM__js.process.stdout.write(message);
  }
);

AM__defineMethod("Test.class", "main", "public",
  function SEL__Test__class__main(argv) {
    this["SEL__print"]("Hello world.\n");
  }
);

AM__initialize();
AM__root.Test["SEL__main"](process.argv);
